...
define('SMW_PLUGINPATH', get_template_directory_uri().'/social-media-widget/');

define('SMW_PLUGINDIR', ABSPATH . 'wp-content/themes/westcomfort/social-media-widget/');

/* Function for CSS */

function Social_Widget_Scripts(){
	// Respects SSL, css is relative to the current file
	wp_register_style( 'social-widget', get_template_directory_uri().'/social-media-widget/social_widget.css' );
